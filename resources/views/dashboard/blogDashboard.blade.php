                ...
                <form action="blogDashboard" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group m-2">
                        ...
                        <input type="text" disabled name="user" class="form-control mt-2 mb-1"
                            id="exampleInputPassword1" value="{{Session('name')}}" placeholder="User Name">
            ...
            <div class="card-body">
                ...
                <table class="table-fixed w-full">
                    ...
                    <tbody class="text-left">
                        ...
                        <tr>
                            <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-left">{{$data['id']}}
                                {{$data['title']}}</th>
                            <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-right">
                                {{$data['description']}}</th>
                            <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-right">{{$data['date']}}
                            </th>
                            <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-right">{{$data['user']}}
                            </th>
                            <th class="w-1/4 pl-5 text-xs font-extrabold text-right">
                                <a href="/editBlog/{{$data['id']}}" type="button" class="mb-2 btn btn-primary">
                                    Edit
                                </a>
                                <a href="/deleteBlog/{{$data['id']}}" type="button" class="mt-2 btn btn-danger">
                                    Delete
                                </a>
                            </th>
                        </tr>
