...
<head>
  ...
  <title>Welcome To Cloudhunt</title>
</head>
...
<div class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300">
    ...
    <div class="flex-none w-56 flex flex-row items-center">
      <img src="../assetsDashbord/img/logo.png" class="flex-none">
        ...
        <div class="dropdown relative md:static">
          ...
          <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
            <div class="w-8 h-8 overflow-hidden rounded-full">
              <img class="w-full h-full object-cover" src="../assetsDashbord/img/user.svg" >
            </div> 

            <div class="ml-2 capitalize flex ">
              <h1 class="text-sm text-gray-800 font-semibold m-0 p-0 leading-none"><?php echo e(Session('name')); ?></h1>
...
<!-- end navbar --><?php /**PATH /Users/ramswami/Desktop/Projects/website/resources/views/dashboard/components/navDashboard.blade.php ENDPATH**/ ?>