<header>
    <div class="container-fluid">
      <div class="row head-col">
        ...
        <div class="col-right d-none d-md-block col-md-9 pr-0">
          <ul>
           <li><i class="fa fa-phone"></i> +91 7412846037 </li>
           <li class="green-cover"><a class="text-light" href="/login" target="_blank"><i class="fa fa-lock"></i> Login </a></li>
  ...
  </header> <?php /**PATH /Users/ramswami/Desktop/Projects/website/resources/views/components/nav.blade.php ENDPATH**/ ?>